...
class Maze:
    ...
    def run(self):
        ...
        '''
        # Guarda a thread em uma variável de instância
    ...
    def _display(self, cell_size=15):
        ...
        while running:
            ...
            if self.solution_found:
                #Renderizar o texto
                text_surface = font.render("Encontrou o tesouro!", True, PURPLE)
                text_rect = text_surface.get_rect(center=(width/2, height/2))
                background_rect = text_rect.inflate(25, 25)
                pygame.draw.rect(screen, LIGHT_PINK, background_rect, border_radius=10)
